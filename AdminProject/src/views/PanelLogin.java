...
public class PanelLogin extends JPanel{
    ...
    public static final String LABEL_TEXT = "Conferences App.Admin";
    ...
    public static final String USER_NAME = "Admin Name";
    public static final String LOGO_PATH = "src/images/logo.png";
    public static final Border BORDER = BorderFactory.createEmptyBorder(110, 200, 170, 200);
    ...
    private void addLogo(){
        ...
        label.setIcon(UtilitiesViews.getImage(LOGO_PATH, 170, 170));
